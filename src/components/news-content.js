    ...
    <div className="card">
      <div className="card-image">
        <figure className="image is-256x256">
          {content.urlToImage ? <img src={content.urlToImage} alt="Placeholder image" /> : ''}
        </figure>
      </div>
      <div className="card-content">
        <div className="media">
          <div className="media-content">
            ...
            <a className="subtitle is-6">{content.author}</a> <a className="ml-3">{publishAt(content.publishedAt)}</a>
          </div>
        </div>
      ...
      <nav className="level">
        ...
        <p className="level-item has-text-centered">
          <a className="button is-primary" target="_blank">Article Link</a>
        </p>
        <p className="level-item has-text-centered">
